import FuriganaRenderer from "@/app/features/new-excercise/components/furiganated-renderer";
import { useEditQuestion } from "../../hooks/useEditQuestions";
import { MdEdit, MdPreview } from "react-icons/md";

const EditParagraphSection = () => {
  const { selectedParagraph, previewMode, setPreviewMode } = useEditQuestion();
  return (
