...
const EditQuestions = () => {
  ...
  return (
    <>
      <div
        className={`absolute inset-0 z-40 flex  transition-all duration-200 overflow-hidden  ${editQuestionSidebar ? "bg-black/30 backdrop-blur-xs" : "pointer-events-none"}`}
      >
        <div className="w-full h-full absolute" onClick={closeEdit}></div>
        <div
