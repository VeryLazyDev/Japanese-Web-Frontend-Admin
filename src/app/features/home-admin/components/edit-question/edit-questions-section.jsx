...
import EditQuestionBottomSection from "./edit-questions-button";
        ...
        <div className="flex-1 flex flex-col justify-between overflow-hidden">
          <div className="flex-1 flex flex-col px-6 space-y-4 overflow-y-auto">
            ...
            <div className="flex gap-2">
              {selectedParagraph &&
                selectedParagraph.questionList.map((question, index) => {
                  const isActive = activeQuestionNo === question.id;

                  return (
                    <button
                      key={question.id}
                      type="button"
                      onClick={() => setActiveQuestionNo(question.id)}
