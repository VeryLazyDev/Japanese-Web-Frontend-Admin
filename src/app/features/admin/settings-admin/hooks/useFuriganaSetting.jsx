...
const useFuriganaSetting = () => {
    ...
    const { PutFuriganaKanjiDataToStorage } = useStorage();
    ...
    const LoadFuriganaData = async () => {
        ...
        if (!isValidType(KanjiDataResType)) {
            throw new Error("Invalid response type");
        }

        const AllFuriganaData = { KanjiData };
    ...
    const PutAllFuriganaKanjiDataToStorage = async (furiganaData) => {
        ...
        const total = furiganaData.KanjiData.length;
        ...
        //     100,
        //     Math.round(
        //       ((furiganaData.KanjiData.length + i + CHUNK_SIZE) / total) * 100,
        //     ),
        //   );
        //   UpdateDialogMessage(
        //     "furigana-loading",
