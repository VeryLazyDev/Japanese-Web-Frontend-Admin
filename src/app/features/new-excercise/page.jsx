...
const NewExercisePage = () => {
    ...
    return (
        <>
            <div className="flex flex-col gap-2 justify-center bg-transparent w-full h-auto overflow-auto px-4">
    ...
    // return (
    //     <>
    //         <div className="flex justify-center bg-transparent w-full h-auto overflow-auto p-10">
    //             <div className="bg-transparent w-3/4">
    //                 <div className="bg-transparent w-full h-auto">
    //                     <h1 className="font-inter font-semibold w-auto pb-3">
    //                         Creat New Exercise
    ...
    //                     <AddParagraph />
    //                     <AddParagraphQuestions />
    //                     <button className="w-full bg-purple-200 text-purple-700 rounded-md text-sm h-8 font-inter my-3">
    //                         Submit
    //                     </button>
    //                 </form>
    //             </div>
